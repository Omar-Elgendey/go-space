...
(1,60,500,'Private Office','Available',4),
(2,61,320,'Meeting Room','Available',8),
(3,62,200,'Dedicated Desk','Not Available',1),
(4,63,100,'Coworking','Available',1),
(5,64,550,'Private Office','Not Available',5),
(6,65,350,'Meeting Room','Available',10),
(7,66,220,'Dedicated Desk','Available',1),
(8,67,120,'Coworking','Not Available',1),
...
INSERT INTO Link (Link_ID, Place_ID) VALUES 
(1111, 11);

DELETE FROM Link
WHERE Link_ID = 1111;

INSERT INTO Rated_places (ID, User_ID, Rating_value)
VALUES (11, 2, 5);

DELETE FROM Rated_places
WHERE ID = 11 AND User_ID = 2;
